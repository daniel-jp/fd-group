              ...
              <Wrap maxW={'full'} justify={'space-between'} spacing={{base: 10, sm: 3, md: 5, lg: 10}}>
                <WrapItem>
                  <Box>
                    ...
                    <Text fontSize={'sm'} textAlign={'start'}  w={{base: 240, sm: 300, md: 300, lg: 330}} p={1} mt={{sm: 3, md: 3, lg: 5}} color="gray.600">
                      {t('ContactText0')}
                    </Text>
                    ...
                    <Box color={'gray.600'}>
                      <VStack spacing={3} alignItems="flex-start">
                        <Box display={'flex'} p={1} fontSize={{base: '1xl', sm: '1xl'}}>
                          ...
                          <Text fontSize={'sm'} p={2} w={{base: 240, sm: 300, md: 300, lg: 330}}>
                        ...
                        <Box display={'flex'} pt={2} p={1} width="350px">
                          ...
                          <Text fontSize={'sm'} p={2} w={{base: 200, sm: 300, md: 300, lg: 330}}>
                   ...
                   <HStack mt={{lg: 5, md: 5}} spacing={5} px={5} alignItems="flex-start">
                    <Link to={'https://www.linkedin.com/company/fd-group-sarl/'} target="_blank"><IconButton aria-label="facebook" variant="ghost" size="lg" isRound={true} _hover={{color:"blue.400",bg: 'gray.800'}} icon={<LinkedinLogo size="28px" />} /></Link>
                      
                      <Link to={'https://twitter.com/FDGROUP2'} target="_blank"> <IconButton aria-label="github" variant="ghost" size="lg" isRound={true} _hover={{color:"blue.400",bg: 'gray.800'}} icon={<TwitterLogo size="28px" />} /></Link>
                      <Link to={'www.fdgroup.company'} target="_blank"> 
